...
const activeFillColor = getComputedStyle(html).getPropertyValue("--logo-active-fill").trim();
const inactiveFillColor = getComputedStyle(html).getPropertyValue("--logo-inactive-fill").trim();
const lightFillColor = getComputedStyle(html).getPropertyValue("--color-lights-500").trim();
const activeOpacity = "1"
const inactiveOpacity = ".25"
const ease = "bounce"
